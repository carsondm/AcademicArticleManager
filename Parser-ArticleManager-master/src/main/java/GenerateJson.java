...
public class GenerateJson {
    ...
    public GenerateJson(String title, String articleAbstract, String publisher, ArrayList<String> authors, ArrayList<String> tags, ArrayList<String> category, ArrayList<String> subCategory, String dateOfPublication) {
        this.title = title;
    ...
    /*
        Generates the Json using the information stored in the variables
